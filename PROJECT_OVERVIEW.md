...
- Account **deletion** exists (§2.4) but **data export does not** — a user can erase themselves but cannot obtain a copy of what is held about them first. That is the other half of finding H3 and blocks the data-subject-rights section of the legal pages.
