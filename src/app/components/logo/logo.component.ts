...
@Component({
  ...
  template: `
    ...
    <rect
       ...
       y="0" />
    <path
       style="font-weight:bold;font-size:100px;font-family:Superclarendon;-inkscape-font-specification:'Superclarendon Bold';text-anchor:middle;fill:#ffffff;stroke-width:1.69032"
